---
name: agentic-learning-sdk-integration
description: Integration patterns and best practices for adding persistent memory to LLM agents using Agentic Learning SDK
---

# Agentic Learning SDK Integration

## Overview
This skill provides universal patterns for adding persistent memory to LLM agents using the Agentic Learning SDK through a 3-line integration pattern that works with OpenAI, Anthropic, Gemini, and other LLM providers.
